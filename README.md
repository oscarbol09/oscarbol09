...
| :--- | :--- | :--- |
| **[Branchbase](https://github.com/oscarbol09/branchbase)** | `Go 1.22+` `Cobra` `PostgreSQL` `MySQL` `SQLite` `Docker` | Zero-config, Git-native local database branching CLI & TCP proxy. Automatically mirrors database states on Git branch checkout. |
| **[AudioBard](https://github.com/oscarbol09/audiobard)** | `Python` `Tauri` `Vue 3` `Piper TTS` `Kokoro` `FFmpeg` | Multi-voice AI audiobook generator from EPUB/TXT with automatic character voice assignment, local/cloud neural synthesis, and desktop GUI. |
| **[ThesisForge](https://github.com/oscarbol09/thesisforge)** | `Python` `RAG` `FastAPI` `Gemini` `APA 7` | Academic research assistant with indexed literature retrieval, methodological rigor validation, and publication-ready formatting. |
...
| **[EduRag](https://github.com/oscarbol09/EduRag)** | `TypeScript` `Next.js` `Supabase` `LangChain` | Educational RAG platform enabling teachers to deploy custom curriculum-trained AI teaching assistants. |
